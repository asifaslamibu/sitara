                ...
                <li class="nav-item align-self-center page-heading">
                    <div class="page-header">
                        <div class="page-title">
                            <h3>Manage Customer Billing Detail</h3>
                        </div>
                    </div>
                </li>
            </ul>
            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                        ...
                        <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group col-md-5">
                                                        ...
                                                        <select id="group" name="group" class="form-control selectpicker basic">
                                                    ...
                                                    <div class="form-group col-md-2  d-flex align-items-center">
                                                        ...
                                                        <button type="submit" name="searchGroup" class="btn btn-primary  font-weight-bold mx-2" style="margin-top:6px ">GET DATA</button>
                    ...
                    <!-- <div class="container-fluid mt-4">
                                <div class="row">
                                <div class="col-md-12">
                                   <a href="addCamplain.php"> <button class="btn btn-primary" >ADD GROUP</button> </a>
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Tracker Imei</th>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">22-4-2020</td>
                                            <td class="text-center">Ahmed</td>
                                            <td class="text-center">433256778323</td>
