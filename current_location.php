...
$resultss = mysqli_query($db,"SELECT * FROM `vehicle_location`");
                            ...
                            ?>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center car_upper"><?php echo $row["car_name"]; ?></td>
                                                <td class="text-center"><?php echo $row["vlocation"]; ?></td>
                                                <td class="text-center"><?php echo $row["imileage"]; ?></td>
