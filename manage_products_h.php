...
$result = mysqli_query($db,"SELECT ph.id,ph.name,ph.status,ph.family,ph.code,pf.name as family_name FROM `products_h`as ph INNER JOIN product_family as pf on ph.family=pf.id");
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="container-fluid mt-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="add_product_h.php"> <button class="btn btn-primary">ADD Products</button>
                                        </a>
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $row["family_name"]; ?></td>
                                            ...
                                            <td class="text-center"><a  href="edit_Product_h.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
                                            ...
                                            <td class="text-center"><a  onclick="return confirm('Are you sure to Delete this User ?');" href="delete_Products_h.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
