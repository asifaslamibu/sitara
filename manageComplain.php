                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="widget-content widget-content-area br-6">
                            ...
                            <div class="container-fluid mt-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="addCamplain.php"> <button class="btn btn-primary">ADD Complaint</button>
                                        </a>
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Asset Plate Number</th>
                                            ...
                                            <th class="text-center">Assign from</th>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $row["vehicle_no"]; ?></td>
                                            <td class="text-center"><?php echo $row["type"]; ?></td>
                                            <td class="text-center"><?php echo $row["complaint_name"]; ?></td>
                                            <td class="text-center"><?php echo $row["phone"]; ?></td>

                                            <td class="text-center"><?php echo $row["complaint_status"]; ?></td>
                                            <td class="text-center"><?php echo $row["assign_to"]; ?></td>
                                            <td class="text-center"><?php echo $row["assign_from"]; ?></td>
                                            <td class="text-center" style="width:max-content">
                                                <?php echo $row["complaint"]; ?></td>
                                            <td class="text-center"><a
                                                    href="editComplaint.php?id=<?php echo $row['id']; ?>"
                                            ...
                                            <td class="text-center"><a onclick="return confirm('Are you sure to Delete this Complaint ?');"
                                                    href="deleteComplaint.php?id=<?php echo $row['id']; ?>"
