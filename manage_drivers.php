...
$result = mysqli_query($db,"SELECT * FROM sitara.driver_detail");
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button class="btn btn-primary" id="add" data-toggle="modal"
                                            data-target="#zoomupModal">Add Driver</button>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.edit_data', function() {
                    ...
                    var employee_id = $(this).attr("id");
                       // alert(employee_id)
                    $.ajax({
                        url: "ajax_edit/update_driver.php",
                        method: "POST",
                        data: {
                        ...
                        success: function(data) {
                            ...
                            $('#cname').val(data.name);
                            $('#d_cnic').val(data.cnic);
                            $('#d_no').val(data.mobile_no);
                            $("#d_pri").val(data.privilage);
                            $('#insert').val("Update");
