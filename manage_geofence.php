...
$resultss2 = mysqli_query($db,"SELECT * FROM `geofenceing`");
// $resultss2 = "SELECT tc_users.name,tc_users.email,users.privilege,users.login,users.description\n"
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="container-fluid mt-4">
                                <div class="row">
                                    <div class="col-md-1">
                                        <a href="add_consignee.php"> <button class="btn btn-primary">ADD Geofence</button>
                                        </a>
                                        

                                    </div>
                                    <div class="col-md-1">
                                        <a href="assign_geofences.php"> <button class="btn btn-primary" >Assign Geofence</button>
                                        </a>
                            ...
                            <?php
                                if (mysqli_num_rows($resultss2) > 0) {
                            ?>
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $row["Province"]; ?></td>
                                            <td class="text-center"><?php echo $row["District"]; ?></td>
                                            <td class="text-center"><?php echo $row["geotype"]; ?></td>
                                            <td class="text-center"><?php echo $row["Coordinates"]; ?></td>
                                            
                                           
                                            
                                            
                                            <td class="text-center"><a  href="view_geo.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
                                            ...
                                            <td class="text-center"><a  onclick="return confirm('Are you sure to Delete this User ?');" href="delete_poi.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
