...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `products_h`(`name`, `status`, `family`, `code`) VALUES ('$name','$status','$family','$code')";

    if (mysqli_query($db, $sql)) {
        echo '<script>alert("Product Family created successfully")</script>';
    } else {
        // $erre ="Error: " . $sql . "<br>" . mysqli_error($db);
        echo "<script>alert('Error: Duplicate Entry , Data already exist');</script>";
                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action = "add_product_h.php" method ="post">
                                                <div class="form-row mb-4">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="code" name="code" placeholder="Enter Product Family Name" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
