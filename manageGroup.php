...
$sql = "INSERT INTO `create_group`(`name`) VALUES ('$group')";
...
$result = mysqli_query($db,"SELECT * FROM create_group");
mysqli_close($db);
?>
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap">ADD GROUP</button> 
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="deleteGroup.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
      ...
      <form action = "manageGroup.php" method = "post">
        <div class="form-row mb-4">
            <div class="form-group col-md-12">
                ...
                <input type="text"id="group" name="group" class="form-control"  placeholder="Enter Group Name">
            </div>
            </div>
