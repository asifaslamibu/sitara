...
$consignee = "SELECT id,consignee_name,geotype FROM sitara.geofenceing where geotype!='black Spote';";
$consignee_result = mysqli_query($db, $consignee);


$id = $_GET['id'];
$qry = mysqli_query($db,"SELECT * FROM sitara.trip_sitara where id='$id'"); // select query
                                            ...
                                            <form action="trip.php" method="post">
                                                <div class="form-row mb-4">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="datetime-local" class="form-control" id="s_time" name="s_time" value="<?php echo $data['name'] ?>"
                                                            placeholder="Enter Start Time" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Consignee</label>

                                                        <select  data-live-search="true" class="form-control selectpicker" id="consignee" name="consignee">
                                                            <option value="" selected>Select Consignee</option>
                                                            <?php foreach($consignee_result as $key => $value1){ ?>
                                                                <option value="<?= $value1['id'];?>"><?= $value1['consignee_name']; ?></option> 
                                                            <?php } 
                                                            ?>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Products</label>

                                                        <select  data-live-search="true" class="form-control selectpicker"  id="products" name="products">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Vehicles</label>

                                                        <select  data-live-search="true" class="form-control selectpicker" id="vehicle" name="vehicle">
                                                            <option value="" selected> Select Vehicle</option>
                                                            <?php foreach($devices_result as $key => $value22){ ?>
                                                                <option value="<?= $value22['id'];?>"><?= $value22['name']; ?></option> 
                                                            <?php } 
                                                            ?>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="datetime-local" class="form-control" id="estimate_time" name="estimate_time"
