    ...
    if(isset($_POST['assigning']))
{
    ...
    if (mysqli_query($db, $sql1)) {
        ...
        echo '<script>alert("Vehicle Not Assign;")</script>';
    ...
    window.location.href='assign_vehicle.php';
    </script>";
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-row mb-4">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4">Email of Users</label>
                                                    <!-- <input type="email" class="form-control" id="email" name="email" placeholder="Enter Email/Username" required> -->
                                                    <select id="user" name="user" class="form-control selectpicker basic">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputAddress">Assign Asset</label>
                                                        <select id="assign" name="assign[]" class="form-control tagging" multiple="multiple"  >   
                                               ...
                                               <div class="container">
                                                    <div class="row">
                                                                <div class="col-md-12">
                                                                    <button type="submit" name="assigning" class="btn btn-primary  font-weight-bold mx-2" name="assigning" style="float: right; ">SAVE</button>
