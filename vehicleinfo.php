                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="overflow: auto;height: 80vh;">
                                            ...
                                            <ul id="myUL">
                                                ...
                                                <li><a href="run.php?id=<?= $value['imei']; ?>">
                                                        ...
                                                        <!-- <span style="height: 20px;float: right; ">
                                                                            ...
                                                                            <a href="javascript:google.maps.event.trigger(map.setCenter(new google.maps.LatLng('<?= $value['lat']; ?>','<?= $value['lng']; ?>')),'click');" >
                                                                            <button style="border: none;border-radius: 5px; background-color: #fff;  box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75);;"><i class="fas fa-crosshairs my-1 text-info" style="font-size: 15px; "></i></button>
                                                                            </a>
