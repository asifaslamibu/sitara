...
<body class="sidebar-noneoverflow starterkit">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (len > 0) {
                        ...
                        // console.log(document.getElementById("html5-extension"))
                        // table_html=document.getElementById("html5-extension");
                        var myRows = [];
                        var $headers = $("th");
    ...
    function send_mail() {
        ...
        $.ajax({
                url: 'http://151.106.17.246:8080/sitara_schedule_email/sitara_email.php',
                type: 'POST',
                data: {
                    check: v_id,
                    from: from1,
                ...
                success: function(data) {
                    ...
                    if(data==1){
                        ...
                        $('#employee_table').html('<h1> Mail Not Send Successfully ..!</h1>');
