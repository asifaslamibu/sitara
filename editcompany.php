...
<?php
    ...
    $id = $_GET['id'];
    $qry = mysqli_query($db,"select * from company where id='$id'"); // select query
                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action = "updatecompany.php?id=<?php echo $data['id']; ?>" method = "post">
                                                <div class="form-row mb-4">

                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Company Name</label>
                                                        <input type="text"id="name" name="name" value="<?php echo $data['name'] ?>" class="form-control"  placeholder="Enter Company Name">
                                                    </div>
                                                    
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Company Email</label>
                                                        <input type="text"id="email" name="email" value="<?php echo $data['email'] ?>" class="form-control"  placeholder="Enter Company Email">
                                                    </div>
                                                    
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Company Phone Number</label>
                                                        <input type="text"id="phone" name="phone" value="<?php echo $data['phone'] ?>" class="form-control"  placeholder="Enter Company Phone Number">
                                                    </div>
