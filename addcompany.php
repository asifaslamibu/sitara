...
$sql = "INSERT INTO `company`(`name`, `email`, `phone`) VALUES ('$name','$email','$phone')";
                                            ...
                                            <form action = "addcompany.php" method = "post">
                                                <div class="form-row mb-4">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text"id="phone" name="phone" class="form-control"  placeholder="Enter Company Phone Number">
                                                    </div>
												...
												<div class="container">
                                                    <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <a class="btn mx-2" href="manageCompany.php" style="float: right;">CANCEL</a>
