                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="page-title">
                            ...
                            <div class="container-fluid mt-4">
                                <div class="row">
                                <div class="col-md-12">
                                   <a href="addcompany.php"> <button class="btn btn-primary" >ADD Company</button> </a>
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Company Phone Number</th>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="editcompany.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
                                            ...
                                            <td class="text-center"><a onclick="return confirm('Are you sure to Delete this Complaint ?');" href="deletecompany.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
