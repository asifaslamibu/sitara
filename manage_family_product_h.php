...
$result = mysqli_query($db,"SELECT * FROM `product_family`");
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <div class="container-fluid mt-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="family_product.php"> <button class="btn btn-primary">ADD Family
                                                Products</button>
                                        </a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
                                                    <input id="toggle_<?php echo $row["id"]; ?>" type="checkbox"
                                                        checked="" name=toggle value="<?php echo $row["id"]; ?>"
                                            ...
                                            <td class="text-center"><a
                                                    href="edit_family_Product_h.php?id=<?php echo $row['id']; ?>"
