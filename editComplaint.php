                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action = "updateComplaint.php?id=<?php echo $id; ?>" method = "post">
                                                <div class="form-row mb-4">
                                                    

                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Asset Plate No</label>
                                                        <input value="<?php echo $data['vehicle_no'] ?>" type="text"id="vehicle_no" name="vehicle_no" class="form-control"  placeholder="Enter Plate number">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input value="<?php echo $data['complaint_name'] ?>" type="text"id="complaint_name" name="complaint_name" class="form-control"  placeholder="Enter User Name">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Phone</label>
                                                        <input value="<?php echo $data['phone'] ?>" type="text"id="phone" name="phone" class="form-control"  placeholder="Enter Phone">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select  id="complaint_status" name="complaint_status" class="form-control selectpicker">
                                                            <option value="<?php echo $data['complaint_status'] ?>" selected><?php echo $data['complaint_status'] ?></option>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="inputAddress">Complaint</label>
                                                        <textarea   id="complaint" name="complaint"  class="form-control" id="exampleFormControlTextarea1" rows="3"><?php echo $data['complaint'] ?></textarea>
                                                    </div>
