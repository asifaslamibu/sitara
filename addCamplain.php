...
$sql = "INSERT INTO `complaint`(`complaint_no`, `type`, `vehicle_no`, `complaint_name`, `phone`, `party_acount`, `complaint_status`, `assign_to`, `assign_from`, `complaint`) VALUES ('','$type','$vehicle_no','$complaint_name','$phone','','$complaint_status','$to','$from','$complaint')";
                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action = "addCamplain.php" method = "post">
                                                <div class="form-row mb-4">
                                                    <!-- <div class="form-group col-md-6">
                                                        <label for="inputEmail4">Complaint No</label>
                                                        <input type="text"id="s_no" name="s_no" class="form-control"  placeholder="Enter Complaint No">
                                                    </div> -->
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Asset Plate No</label>
                                                        <input type="text"id="vehicle_no" name="vehicle_no" class="form-control"  placeholder="Enter Plate number">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Company User Name</label>
                                                        <input type="text"id="complaint_name" name="complaint_name" class="form-control"  placeholder="Enter User Name">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    <!-- <div class="form-group col-md-6">
                                                        <label for="inputAddress">Party Acount</label>
                                                        <input type="text"id="party_acount" name="party_acount" class="form-control"  placeholder="Enter Party Acount">
                                                    </div> -->
                                                    <div class="form-group col-md-12">
                                                        <label for="inputPassword4">Complaint Status</label>
                                                        <select id="complaint_status" name="complaint_status" class="form-control selectpicker">
                                                            <option selected>Choose...</option>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Assign To</label>
                                                        <!-- <input type="text"id="to" name="to" class="form-control"  placeholder="Assign To"> -->
                                                        <select id="to" name="to" class="form-control selectpicker">
                                                            <option selected>Choose...</option>
                                                            <option value=""></option>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Assign From</label>
                                                        <!-- <input type="text"id="from" name="from" class="form-control"  placeholder="Assign From"> -->
                                                        <select id="from" name="from" class="form-control selectpicker">
                                                            <option selected>Choose...</option>
                                                            <option value=""></option>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea  id="complaint" name="complaint"  class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                                    </div>
												...
												<div class="container">
                                                    <div class="row">
                                                                <div class="col-md-12">
                                                                    <button type="submit"  class="btn btn-primary  font-weight-bold mx-2" style="float: right; ">SAVE</button>
                                                                    <a class="btn mx-2" href="manageComplain.php" style="float: right;">CANCEL</a>
