...
if(isset($_POST['dvla']))
{
    // echo "You entered the number " . $_POST['to']; 
    

    $to_email = mysqli_real_escape_string($db,$_POST['to']);
    $subject = mysqli_real_escape_string($db,$_POST['subject']); 
    $body = mysqli_real_escape_string($db,$_POST['text1']); 
    


//     $to_email = "abdulsamadq67@gmail.com";
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                                ...
                                                <div class="compose-box">
                                                    <div class="compose-content">
                                                        <form action="" method="POST">
                                                            ...
                                                            <div class="d-flex mb-4 mail-subject mt-4">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                                                <div class="w-100">
                                                                    <textarea id="text1" name="text1" rows="10" cols="50" style=" border: 1px solid #ced4da;">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button id="btn-send" class="btn" name="dvla"> Send</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
