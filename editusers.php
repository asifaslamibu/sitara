...
// $company = "SELECT name , id from users";
// $result1 = mysqli_query($db, $company);
$id = $_GET['id'];
$qry = mysqli_query($db,"SELECT * FROM sitara.users where id='$id'"); // select query
echo "SELECT * FROM sitara.users where id='$id'";
                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action="updateusers.php?id=<?php echo $data['id'] ?>" method="post">
                                                <div class="form-row mb-4">
                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4">Username</label>
                                                        <input value="<?php echo $data['name'] ?>" type="text" class="form-control" id="name" name="name"
                                                            placeholder="Enter Username" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4">Email</label>
                                                        <input value="<?php echo $data['email'] ?>" type="email" class="form-control" id="email" name="email"
                                                    ...
                                                    <div class="form-group col-md-6  ">
                                                        ...
                                                        <label for="" class="lab"> Enter
                                                            Password</label>
                                                        <input value="<?php echo $data['description'] ?>" type="password" id="password" required minlength="8"
                                                    ...
                                                    <div class="form-group col-md-6 ">
                                                        ...
                                                        <input value="<?php echo $data['description'] ?>" type="password" id="confirm_password"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <a class="btn mx-2" href="manageusers.php"
                                                                style="float: right;" id="back_btn">CANCEL</a>
