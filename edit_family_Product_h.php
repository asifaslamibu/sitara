...
$id = $_GET['id'];
$qry = mysqli_query($db,"SELECT * FROM `product_family` where id='$id'"); // select query
                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action = "update_product_family_h.php?id=<?php echo $id; ?>" method ="post">
