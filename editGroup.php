...
<?php
    ...
    $id = $_GET['id'];
    $qry = mysqli_query($db,"select * from create_group where id='$id'"); // select query
                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action = "updateGroup.php?id=<?php echo $id; ?>" method = "post">
                                                <div class="form-row mb-4">
                                                <div class="form-group col-md-12">
                                                    <label for="inputAddress">Group Name</label>
                                                    <input type="text"id="group" name="group" class="form-control" value="<?php echo $data['name'] ?>"  placeholder="Enter Group Name">
                                                </div>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <a class="btn mx-2" href="manageGroup.php" style="float: right;">CANCEL</a>
