...
$comp = "SELECT * FROM complaint";
 $result = mysqli_query($db, $comp);
?>
                            ...
                            <div class="chat-system">
                                ...
                                <div class="user-list-box">
                                    ...
                                    <div class="people">
                                        ...
                                        <?php foreach($result as $key => $value){ $i=1; ?>
                                            <div class="person" data-chat="<?= $value['id']; ?>">
                                            <div class="user-info">
                                                <div class="f-head">
                                                ...
                                                <div class="f-body">
                                                    <div class="meta-info">
                                                        <span class="user-name" data-name="Nia Hillyer"><?= $value['complaint_name']; ?></span>
                                                        <span class="user-meta-time"><?= $value['vehicle_no']; ?></span>
                                                    </div>
                                ...
                                <div class="chat-box">
                                    ...
                                    <div class="overlay-video-call">
                                        <img src="assets/img/video-chat.jpg" class="video-caller" alt="video-chat">
                                        <div class="">
                                            <div class="calling-user-info">
                                                <div class="d-flex">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left-circle go-back-chat"><circle cx="12" cy="12" r="10"></circle><polyline points="12 8 8 12 12 16"></polyline><line x1="16" y1="12" x2="8" y2="12"></line></svg>
                                    ...
                                    <div class="chat-box-inner">
                                        ...
                                        <div class="chat-conversation-box">
                                            <div id="chat-conversation-box-scroll" class="chat-conversation-box-scroll">
                                                    ...
                                                    <?php foreach($result as $key => $value){ $i=1; ?>
                                                        <div class="chat" data-chat="<?= $value['id']; ?>">
                                        ...
                                        <div class="chat-footer">
                                            <div class="chat-input">
                                                <form class="chat-form" action="javascript:void(0);">
                                                    ...
                                                    <input type="hidden" class="message-sender-id" value="<?= $value['id']; ?>">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
