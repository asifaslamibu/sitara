...
$result = mysqli_query($db,"SELECT rm.*,tm.driver_cnic,tm.driver_contact,tm.driver_helper_cnic,tm.driver_helper_contact,tm.trip_count,dc.name as device_name FROM sitara.receive_main as  rm 
inner join sitara.trip_main  as tm on rm.trip_id=tm.id
inner join sitara.devices as dc on tm.lorry_no=dc.uniqueId;");
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Loory Name</th>
                                            <th class="text-center">Driver CNIC</th>
                                            <th class="text-center">Driver Contact No</th>
                                            <th class="text-center">Driver Helper CNIC</th>
                                            <th class="text-center">Driver Helper Contact No</th>
                                            <th class="text-center">Trip No</th>
                                            <th class="text-center">Number of Trip</th>
                                            <th class="text-center">Document</th>
                                            <th class="text-center">Diverstion in the Trip</th>
                                            <th class="text-center">Product dispatched to consignees</th>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $row["driver_helper_cnic"]; ?></td>
                                            <td class="text-center"><?php echo $row["driver_helper_contact"]; ?></td>
                                            <td class="text-center"><?php echo $row["trip_id"]; ?></td>
                                            <td class="text-center"><?php echo $row["trip_qty"]; ?></td>
                                            <td class="text-center"><?php echo $row["upload_receiving"]; ?></td>
                                            <td class="text-center"><?php echo $row["diverstion"]; ?></td>
                                            <td class="text-center"><?php echo $row["dispatched"]; ?></td>
                                            ...
                                            <td class="text-center"><a name="edit" id="<?php echo $row["id"]; ?>"
                                                    ...
                                                    title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg></a>
                                            </td>
                                            <!-- <td class="text-center"><a  onclick="return confirm('Are you sure to Delete this User ?');" href="deleteapp.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
            ...
            <div class="modal-dialog modal-xl">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color:#000" id="title_edit">View Trips</h5>
                        ...
                        <div class="container my-4">
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-4" id="example">
                                        <caption>List of all Trips</caption>
                                        <thead>
                                                <tr>
                                                    ...
                                                    <th>Product</th>
                                                    <th>Quantity</th>
                                                    <th>Remark Case Product</th>
                                                    <th>Deliverd Quantity</th>
                                                    <th>Shortage Litr</th>
                                                    <th>Receive Upload</th>
                                                </tr>
                                            </thead>
    ...
    .draw();
                            for (var i = 0; i < len; i++) {
                                ...
                                t.row.add( [
                                    ...
                                    data[i][6],
                                    data[i][7],
                                    '<a href="uploads/'+data[i][8]+'" target="_blank">View Document</a>'
                                ]).draw();
                                
                                // somi1.row.add([name,dateStart,'', dateEnd ,'', diffjour]);
