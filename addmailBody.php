...
$sql = "INSERT INTO `email`(`title`, `body`) VALUES ('$title','$body')";
echo $sql;
                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action="addmailBody.php" method="post">
                                                <div class="form-row mb-4">

                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Mail Title</label>
                                                        ...
                                                        <div class="widget-content widget-content-area form-group col-md-12">
                                                            <div id="editor-container">
                                                                <textarea id="body" name="body" rows="10" cols="50" spellcheck="true"></textarea>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <a class="btn mx-2" href="manageComplain.php"
