...
<?php
    ...
    $id = $_GET['id'];
    $qry = mysqli_query($db,"select * from devices where uniqueId='$id'"); // select query
                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action = "updateAsset.php?id=<?php echo $id; ?>" method = "post">
                                                <div class="form-row mb-4">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Sim No</label>
                                                        
                                                       
                                                        <input type="text" value="<?php echo $data['simno'] ?>" class="form-control" id="sim" name="sim" placeholder="">
                                                    ...
                                                    <!-- <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" value="<?php echo $data['uniqueId'] ?>" class="form-control" id="imei" name="imei" placeholder="" readonly>

                                                    </div> -->
                                                    
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Vehicle Make</label>
                                                        <input type="text" value="<?php echo $data['vehicle_make'] ?>" class="form-control" id="make" name="make" placeholder="">
                                                    </div>
