...
$result = mysqli_query($db,"SELECT * FROM sitara.users where privilege='app'");
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="container-fluid mt-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="addapp.php"> <button class="btn btn-primary">ADD App User</button>
                                        </a>
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">APP Tracking</td>
                                            <td class="text-center"><?php echo $row["telephone"]; ?></td>

                                            
                                            
                                            <td class="text-center"><a  href="editusers.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
