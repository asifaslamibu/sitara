...
$poi = "SELECT consignee_name as name , id,type from geofenceing";
$poi1 = mysqli_query($db, $poi);
$devices = "SELECT name , uniqueId as id from devices";
$devices1 = mysqli_query($db, $devices);

// error_reporting(0);

if(isset($_POST['assign_geo'])){

    $geofence_id = mysqli_real_escape_string($db,$_POST['geofence_id']);
    $carss = $_POST['carss']; 
    ...
    foreach ($carss as $assign) {
        $sql1 = "INSERT INTO `geo_assign_vehicle`(`device_id`, `geofence_id`)
    VALUES ('$assign','$geofence_id')";

    if (mysqli_query($db, $sql1)) {
        // echo '<script>alert("Assets assigned successfully")</script>';
        
    } else {
        echo '<script>alert("Geofence Not Assign;")</script>';

    // echo "Error: " . $sql . "<br>" . mysqli_error($db);
    }
    }
    echo "<script>
    alert('Geofence assigned successfully');
    window.location.href='assign_geofences.php';
    </script>";
...
<body class="sidebar-noneoverflow starterkit">
                        ...
                        <div class="widget-content-area br-4">
                            <div class="widget-one">
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action="assign_geofences.php" method="post">
                                            <div class="n-chk">
                                                ...
                                                <div class="form-row mb-4">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control tagging" multiple="multiple" required
                                                            id="carss" name="carss[]">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="geofence_id" name="geofence_id" required
                                                            class="form-control selectpicker">
                                                            <option>Choose...</option>
                                                            <?php foreach($poi1 as $key => $value){ ?>
                                                            <option value="<?= $value['id'];?>"><?= $value['name']; ?> (<?= $value['type']; ?>)
                                                            </option>
                                                            <?php } 
                                                            ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <button class="btn btn-primary  font-weight-bold mx-2"
                                                                name="assign_geo" type="submit"
                                                                style="float: right; ">SAVE</button>
                                                            <a class="btn mx-2" href="manage_geofence.php"
    ...
    $("#checkboxss").click(function() {
        if ($("#checkboxss").is(':checked')) {
            // alert("checked")
            $("#carss > option").prop("selected", "selected");
            $("#carss").trigger("change");
        } else {
            // alert("uncheked")
            $('#carss').val(null).trigger('change');
        }
    });
    </script>
