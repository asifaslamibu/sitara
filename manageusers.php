...
$result = mysqli_query($db,"SELECT * FROM sitara.users where privilege='viewer'");
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="container-fluid mt-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="addusers.php"> <button class="btn btn-primary">ADD Users</button>
                                        </a>
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a  onclick="return confirm('Are you sure to Delete this User ?');" href="deletecrmusers.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip"
