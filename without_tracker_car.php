...
$result = mysqli_query($db,"SELECT * FROM sitara.devices where description='without_tracker'");
                ...
                <li class="nav-item align-self-center page-heading">
                    <div class="page-header">
                        <div class="page-title">
                            <h3>Manage Without tracker vehicle</h3>
                        </div>
                    </div>
                </li>
            </ul>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button class="btn btn-primary" id="add" data-toggle="modal"
                                            data-target="#zoomupModal">Add Vehicle</button>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color:#000" id="title_edit">Add without tracker vehicle</h5>
                                    ...
                                    <form method="post" id="insert_form" enctype="multipart/form-data">
                                        <div class="form-row mb-4">
                                            ...
                                            <!-- <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="d_cnic" name="d_cnic"
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="d_no" name="d_no"
                                                    placeholder="Enter Mobile No" >
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="inputEmail4">Privilage</label>
                                                <select type="text" class="form-control" id="d_pri" name="d_pri"
                                                    placeholder="Enter Mobile No" >
                                                    <option></option>
            ...
            $(document).ready(function() {
                ...
                $('#insert_form').on("submit", function(event) {
                    ...
                    if ($('#cname').val() == "") {
                        ...
                        $.ajax({
                            url: "ajax_edit/insert_vehicle.php",
                            method: "POST",
                ...
                $(document).on('click', '.edit_data', function() {
                    ...
                    var employee_id = $(this).attr("id");
                       // alert(employee_id)
                    $.ajax({
                        url: "ajax_edit/edit_without.php",
                        method: "POST",
                        data: {
                        ...
                        success: function(data) {
                            ...
                            $('#employee_id').val(data.uniqueId);
                            $('#cname').val(data.name);
                            $('#insert').val("Update");
                            $('#title_edit').text("Edit Vehicle Name");
