                                        ...
                                        <div class="col-md-12">
                                            <form action = "imei.php" method = "post">
                                                <div class="form-row mb-4">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Tracker</label>
                                                        <input type="text"id="imei" name="imei" class="form-control"  placeholder="Enter Tracker Imei">
                                                    </div>
                                                    
                                                    
                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress">Sim Number</label>
                                                        <input type="text"id="sim" name="sim" class="form-control"  placeholder="Enter Sim Number">
                                                    </div>
                                                    <div class="form-group col-md-6">
												...
												<div class="container">
                                                    <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <a class="btn mx-2" href="manageimei.php" style="float: right;">CANCEL</a>
