                            ...
                            ?>
                                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">SIM NO</th>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center car_upper"><?php echo $row["licensepn"]; ?></td>
                                                <td class="text-center"><?php echo $row["simno"]; ?></td>
                                                <td class="text-center"><?php echo $row["vehicle_make"]; ?></td>
                                                ...
                                                <td class="text-center"><a
                                                        ...
                                                        href="deleteAsset.php?id=<?php echo $row['uniqueId']; ?>"
